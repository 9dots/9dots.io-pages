...
## Engage - 5 minutes
1. Show students the completed TalkToMe App on Android device or emulator. Input different text into the TextBox to show them what their final product should look like!
...
4. Add two quick challenges: 
	- Review that properties are used to further specify the components on the designer page. Have students change the text on 	Button 1 from “Text for Button 1” to “Talk To Me!”
	- Back to the blocks page: Have students change their app to say “My name is ____________”

	- The green text box will tell your app to say anything that is typed into the TextBox1 when the app is running.
