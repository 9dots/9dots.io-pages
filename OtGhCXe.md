...
org: 9dots
objective: 
  - Design three screens for a health app using the designer page components on the AppInventor
id: "9dots-OtGhCXe"
attachments: 
  - path: "http://uploads.9dots.io/OxKiiL9.gdoc"
    name: "Health App Day 5: Handout.gdoc"
  - path: "http://uploads.9dots.io/OxKijjq.gdoc"
    name: "Health App Day 6: Handout.gdoc"
...
## Setup
### materials:
- Health App [Day 5: Handout](http://uploads.9dots.io/OxKiiL9.gdoc)
- Health App [Day 6:Handout](http://uploads.9dots.io/OxKijjq.gdoc)
...
1. Provide students with a screen shot of 'Screen1' and 'Screen2' on [Day 5: Handout](http://uploads.9dots.io/OxKiiL9.gdoc). 
...
- Instruct students to edit all the component’s properties to replicate 'Screen1' and 'Screen2' from their [Day 5: Handout](http://uploads.9dots.io/OxKiiL9.gdoc) (5 minutes). Review answers. 
...
1. Challenge students to select the correct components for the Info screen to match the screenshot on [Day 6:Handout](http://uploads.9dots.io/OxKijjq.gdoc). 
2. Challenge students to organize their Info screen layout to match the screenshot on [Day 6:Handout](http://uploads.9dots.io/OxKijjq.gdoc).
